...
class API_Glossary extends \WP_REST_Controller {
	...
	public function register_routes() {
		...
		// return all Glossaries whose name matches letter
		// wp-json/kc/glossary/{alpha}
	...
	public function get_items( $request ) {
		...
		foreach( $glossary->posts as $definition ) {
			$items[] = $this->return_item_array( $definition );
		}
